...
# ------------------- ТОЛЬКО ДЛЯ RENDER (100% работает) -------------------
import threading
import os
...
@app.get("/")
async def root():
    return {"status": "alive", "message": "Шпион 2.0 работает 24/7"}
...
async def run_bot():
    ...
    print("Шпион 2.0 успешно запущен и работает 24/7")
    await dp.start_polling(bot)

# ←←← ЭТО ГЛАВНОЕ — запускаем и веб, и бота
